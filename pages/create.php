 ...
 * - en GET : quand on tape simplement l'adresse /index.php?page=create 
 * dans le navigateur, c'est une requête en GET par défaut
 * => Elle affiche simplement le formulaire HTML
 * 
 * - en POST : quand on soumet le formulaire, le navigateur va rappeler
 *  /index.php?page=create mais cette fois ci en POST
